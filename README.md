...
AttendTrack is a modern, full-stack attendance tracking system designed for small to medium-sized teams. It features a vibrant, mobile-optimized web application and a seamlessly integrated Telegram Bot for Work From Home (WFH) management.
...
- **Telegram Bot Integration**: Employees can clock IN/OUT and request WFH directly from Telegram.
...
4. **Integration**: Telegram Bot API (WFH Management).
